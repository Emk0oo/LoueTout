 ...
 */
final class Version20240925100249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id UUID NOT NULL, rent_history_id UUID DEFAULT NULL, instance_id UUID NOT NULL, label VARCHAR(255) NOT NULL, description TEXT NOT NULL, price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN product.rent_history_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE rent_history (id UUID NOT NULL, instance_id UUID NOT NULL, price DOUBLE PRECISION NOT NULL, started_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ended_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN "user".rent_history_id IS \'(DC2Type:uuid)\'');
