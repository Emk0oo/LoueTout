 ...
 */
final class Version20240925140324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE instance_settings (id UUID NOT NULL, instance_id UUID NOT NULL, key VARCHAR(255) NOT NULL, value VARCHAR(510) NOT NULL, PRIMARY KEY(id))');
