 ...
 */
final class Version20240925121647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD rent_by_id UUID NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04AD4B99D2B2');
        $this->addSql('ALTER TABLE product DROP rent_by_id');
    }
}
